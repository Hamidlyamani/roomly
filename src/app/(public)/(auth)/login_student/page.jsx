    ...
    <>
      <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
           <span className='block  text-3xl font-sans font-black text-prim text-center '>  <Image src="/imgs/logo.png" alt='rommly' width={0}
                           height={0}
                           sizes="100vw"
                           className="w-24 h-auto m-auto" /></span>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form action="#" method="POST" className="space-y-6">
            ...
            <div>
              <button
                type="submit"
                className="flex w-full justify-center rounded-md bg-prim bg-purple-950 px-3 py-1.5 text-sm/6 font-semibold text-white hover:bg-sec focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
              >
                Se connecter
              </button>
            </div>
